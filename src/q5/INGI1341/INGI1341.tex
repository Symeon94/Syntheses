...
\paragraph{Hubs} Un hub est un relay du physical layer qui recoit un signal sur une de ses interface et le transmets sur toute les autres interfaces. Les hosts peuvent être directement relié à un Ethernet hubs.
